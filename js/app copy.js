...
let clock = JSON.parse(localStorage.getItem('clock')) || JSON.parse(JSON.stringify(user));
...
function init() {
    ...
    resetDesignBtn.addEventListener("click", function () {
        updateClock('userTextMainColor', { ...user.userTextMainColor });
        updateClock('userTextHighlightColor', { ...user.userTextHighlightColor });
        updateClock('userClockBgColor', { ...user.userClockBgColor });
        updateClock('userClockBorder', { ...user.userClockBorder });

        updateClock('showTextGlow', user.showTextGlow);
        updateClock('showClockShadow', user.showClockShadow);
    ...
    resetImgBtn.addEventListener("click", function () {
        updateClock('userPageBg', { ...user.userPageBg });
