...
const inputName = document.querySelector('.avatar-page input');
...
function avatarPageInit() {
    let elements = document.querySelectorAll('.avatar-page> *');
    elements.forEach(el => {
        fadeOut(el, 0);
    })
    TweenMax.delayedCall(0.6, staggerFromToElements, [elements, 1, 0.2]);
...
function gameModePageInit() {
    let elements = document.querySelectorAll('.game-mode-page > *');
    elements.forEach(el => {
        fadeOut(el, 0);
    })
    TweenMax.delayedCall(0.6, staggerFromToElements, [elements, 1, 0.2]);
